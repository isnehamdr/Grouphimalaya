...
const Navbar = () => {
  ...
  const isBusinessActive = ['/automobile', '/realestate', '/hospitality', '/banking', '/agriculture', '/engineering', '/livents-studios'].includes(url)
      ...
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div
          className={`
            ...
            ${isPill
              ? 'mx-4 sm:mx-8 md:mx-16 lg:mx-24 xl:mx-72 mt-4 rounded-full bg-[#0e1116]/90 backdrop-blur-md border border-white/10 shadow-sm px-4'
            ...
            <div className="flex items-center justify-start">
              <Link href="/" className="flex-shrink-0 flex items-center -my-4">
                <img
                  src={himalayanlogo}
                  alt="Logo"
                  className="h-20 sm:h-20 md:h-[100px] w-auto object-contain"
...
">
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              {/* <img src={himalayanlogo} alt='logo' className='w-32'/> */}
              </div>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-1">
          ...
          <Link href="/blog" className="px-4 py-3 rounded-xl text-sm font-medium text-white hover:bg-white/5 transition-colors" onClick={() => setMobileOpen(false)}>News/Blog</Link>
          ...
          <Link href="/community" className="px-4 py-3 rounded-xl text-sm font-medium text-white hover:bg-white/5 transition-colors" onClick={() => setMobileOpen(false)}>CSR</Link>
        </div>

        <div className="px-4 pb-6 pt-3 border-t border-white/10 flex flex-col gap-1.5 items-center">
