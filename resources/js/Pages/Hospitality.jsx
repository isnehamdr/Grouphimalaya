...
import imperial from '../../../public/images/imperial_image.jpg'
import anakibar from '../../../public/images/anaki_bar.jpg'
...
const properties = [
  ...
  {
  id: 'anaki-bar',
  tag: 'Premium Bar & Lounge',
  tagColor: '#fee2e2',
  tagBg: '#7f1d1d',
  accent: '#ef4444',
  name: 'Anaki Bar & Lounge',
  location: 'Lakeside, Pokhara',
  description:
    'A premier nightlife destination in Pokhara, Anaki Bar & Lounge offers a sophisticated blend of high-energy music, craft cocktails, and a modern aesthetic. Located in the vibrant Lakeside district, it serves as a central hub for both locals and travelers seeking a premium evening experience with live DJ sets and a lively social atmosphere.',
  highlights: [
    'State-of-the-art sound and lighting system featuring nightly live DJ performances',
    'Extensive menu of signature cocktails, fine spirits, and gourmet appetizers',
    'Modern, spacious interior with a dedicated dance floor and VIP seating areas',
    'Perfect for social gatherings, birthday celebrations, and experiencing Pokhara’s upscale nightlife',
  ],
  image: anakibar, // Replace with your specific image variable
  imageAlt: 'Anaki Bar & Lounge, Lakeside Pokhara',
},
]
